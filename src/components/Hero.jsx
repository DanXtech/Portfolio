...
import CvDocument from "../assets/kehindeAts cv-1.pdf";
...
const Hero = () => {
  ...
  words: [
    "Software Developer",
    "Good in frontend Development when desinging website and mobile apps",
    "Experienced in API integration ",
    "Processing to be a full-stack developer",
    "Graphics Designer",
    "Good with JavaScript, TypeScript",
    "React, Next.js, Angular & Tailwind Expert",
