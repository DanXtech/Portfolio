            ...
            <div className="container py-14" id="contact">
                ...
                <div className="flex items-center justify-center  ">
                    <div className="flex items-center justify-center space-x-6 bg-gray-300 w-[500px] py-3 rounded-full"
                        ...
                        data-aos-delay="400"
                    >
                        <a href="https://wa.me/08108790725" className="flex items-center justify-center w-12 h-12 bg-primary  border-2 border-main-color rounded-full lg:text-2xl sm:text-[16px] text-main-color transition duration-300 hover:text-text-color cursor-pointer  hover:bg-main-color transform hover:scale-125">
                            <WhatsApp />
                        </a>
